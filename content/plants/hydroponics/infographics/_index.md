...
<div class="intro">
Community food projects are about ensuring that communities have access to healthy food that is grown locally and sustainably.
...
However, there exists a gap around growing seasons when outdoor plants don't grow.
My goal is to expand on that goal by experimenting with a low-cost and scalable method of hydroponics to further develop food security on campus.
</div>
...
Because of this, plants are generally protected from soil-bourne pests and diseases and can be grown without harsh pesticides.
...
Heavy metal contamination and pesticide use are both harmful to human health, and a frequent cause for concern in global food chains. 
In a suburban sample from China, 84% of vegetable samples grown using conventional methods contained pesticide residue.
In that same sample, a 16-fold increase in heavy metal concentrations was seen in conventional lettuce compared to lettuce grown using hydroponic methods.[^1]

With proper food safe equipment, heavy metal contamination is not a risk. 
Here, we suspend plants in a food-safe, BPA-free, polypropylene plastic net cup[^4] inside of glass mason jars.
No pesticides or insecticides will be used in the cultivation of these plants. 
...
Our method of hydroponics, known as the Kratky method, is one of the easiest and low-cost ways of growing hydroponic crops in a passive, sustainable way.
...
As the plant grows, it absorbs some of the nutrient-rich water to support its growth.
Air fills in the gap left by the now-absorbed water. 
This air-gap is necessary to sustain cellular respiration in the plant's roots.
The plant develops small air-roots that are used to take in oxygen from the air.
...
<h3 class="title">Future Plans</h3>
<div class="intro">

The Kratky method was selected for it's low-cost, low-tech materials, and low-footprint.
Plans this summer are to see how viable growing hydroponic lettuce is on campus using the Kratky method.
