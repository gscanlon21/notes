...
**Acey-Deucey**
: Each player starts with fifteen checkers off the board.
: {{ <image title="Acey-Deucey Setup" file="一Acey-Deucey_Start.gif" inline={true} /> }}

**Fevga**
: It features no hitting and the players move in the same direction around the board.
: {{ <image title="Fevga Setup" file="一Fevga_Start.gif" inline={true} /> }}

**Hyper-Backgammon**
: This backgammon variant is played with each side having just three checkers.
: {{ <image title="Hyper-Backgammon Setup" file="一Hyper_Start.gif" inline={true} /> }}
...
{{ <image title="LongGammon Setup" file="一LongGammon_Start.gif" inline={true} /> }}

**Nackgammon**
: It is the same as the regular game except that each player starts with two additional back checkers.
{{ <image title="Nackgammon Setup" file="一Nackgammon_Start.gif" inline={true} /> }}

**Plakoto**
: The opponent's checkers are pinned rather than hit.
{{ <image title="Plakoto Setup" file="一Plakoto_Start.gif" inline={true} /> }}
 
**Tawula**
: Players start at diagonally-opposite corners and move around the board in the same direction.
{{ <image title="Tawula Setup" file="一Tawula_Start.gif" inline={true} /> }}
