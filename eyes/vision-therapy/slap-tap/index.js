...
options.addEventListener('reset', () => setTimeout(setAlt));
...
options.addEventListener('reset', () => setTimeout(setLetterGap));
...
options.addEventListener('reset', () => setTimeout(generateSlapTapGrid));
