...
options.addEventListener('reset', () => setTimeout(setLetterSpacing));
...
options.addEventListener('reset', () => setTimeout(setLineHeight));
...
options.addEventListener('reset', () => setTimeout(setLength));
lengthRange.addEventListener("input", setLength);
setLength();

const onRGCheck = () => chart.aToggleClass('red-green', redGreenCheck.checked);
options.addEventListener('reset', () => setTimeout(onRGCheck));
redGreenCheck.addEventListener('change', onRGCheck);
onRGCheck()

options.addEventListener('reset', () => setTimeout(generateParagraphs));
